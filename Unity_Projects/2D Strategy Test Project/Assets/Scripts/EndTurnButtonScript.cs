...
public class EndTurnButtonScript : MonoBehaviour
{
    ...
    public void OnButtonPressed()
    {
        ...
        if (_turnManagerScript.CurrentPlayer.isHumanPlayer) _turnManagerScript.EndTurn();
    }
    ...
    private void UpdateButtonText() 
    {
        ...
        buttonText.text = "End " + _turnManagerScript.CurrentPlayer.playerName + "'s Turn " + _turnManagerScript.TurnCounter;
